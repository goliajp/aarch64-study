/* @ts-self-types="./aarch64_sim.d.ts" */
...
export class Cpu {
     ...
     */
    entry_pc() {
        const ret = wasm.cpu_entry_pc(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
     * @returns {bigint}
     ...
     */
    mem_slice(start, len) {
        const ret = wasm.cpu_mem_slice(this.__wbg_ptr, start, len);
    ...
    output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cpu_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    uart_addr() {
        const ret = wasm.cpu_uart_addr(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('aarch64_sim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
